...
insert into db3_1 (AccountID) select distinct (AccountID) from ott where ErrorMsg = '' and TransactionStart between '2015-04-04' and '2015-04-11 23:59:59' and AssetName = '[23382] Outlander: Ep 109 - The Reckoning (Episode)';
...
insert into db3_2 select distinct AccountID from ott where ErrorMsg = '' and TransactionStart between '2015-04-04' and '2015-04-04 23:59:59' and AssetName != '[23382] Outlander: Ep 109 - The Reckoning (Episode)';
...
insert into db3_w select distinct AccountID from ott where ErrorMsg = '' and TransactionStart between '2014-04-06' and '2015-03-06 23:59:59';
