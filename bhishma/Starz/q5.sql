...
#2 Ash vs Evil Dead: Ep 101 - El Jefe    [25589] The Girlfriend Experience: Ep 101 - Entry (Episode)
...
insert into db3_1 (AccountID) select distinct (AccountID) from dum2 where ErrorMsg = '' and TransactionStart between '2016-04-10' and '2016-04-17 23:59:59' and number = '25589';
...
insert into db3_2 select distinct AccountID from dum2 where ErrorMsg = '' and TransactionStart between '2016-04-10' and '2016-04-10 23:59:59' and number != '25589';
...
insert into db3_w select distinct AccountID from dum2 where ErrorMsg = '' and TransactionStart between '2015-04-11' and '2016-03-11 23:59:59';
