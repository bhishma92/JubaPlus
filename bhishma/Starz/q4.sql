#query 0
#4 
#3 "[25851] Ep 201 - Through A Glass, Black Sails: Ep 301 - XIX
#2 Ash vs Evil Dead: Ep 101 - El Jefe    "[25851] Ep 201 - Through A Glass
...
insert into db3_1 (AccountID) select distinct (AccountID) from dum2 where ErrorMsg = '' and TransactionStart between '2016-04-09' and '2016-04-16 23:59:59' and number = '25851';
...
insert into db3_2 select distinct AccountID from dum2 where ErrorMsg = '' and TransactionStart between '2016-04-09' and '2016-04-09 23:59:59' and number != '25851';
...
insert into db3_w select distinct AccountID from dum2 where ErrorMsg = '' and TransactionStart between '2015-04-10' and '2016-03-10 23:59:59';
