...
insert into db3_1 (AccountID) select distinct (AccountID) from dum2 where ErrorMsg = '' and TransactionStart between '2015-10-31' and '2015-11-07 23:59:59' and number = '24829';
...
insert into db3_2 select distinct AccountID from dum2 where ErrorMsg = '' and TransactionStart between '2015-10-31' and '2015-10-31 23:59:59' and number != '24829';
...
insert into db3_w select distinct AccountID from dum2 where ErrorMsg = '' and TransactionStart between '2014-11-02' and '2015-10-02 23:59:59';
