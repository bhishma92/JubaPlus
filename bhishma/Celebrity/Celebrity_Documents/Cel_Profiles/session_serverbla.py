...
def main():
    ...
    df = pd.read_csv('/home/dummy/try/data.tsv', header=None, delimiter="\t", error_bad_lines = False)
            ...
            if(df[0][index] == df[0][index-1]):
                ...
                if (df[2][index-1] == df[2][index]):
                    ...
                    if  tt < 3600:
                        ...
                        a = datetime.datetime(q[0],q[1],q[2],t1[0],t1[1],t1[2])
                        b = datetime.datetime(d2[0],d2[1],d2[2],t2[0],t2[1],t2[2])
    ...
    df.to_csv('/home/dummy/try/sesOut' + '.tsv', index = False, header= None, sep='\t')
