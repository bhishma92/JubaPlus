...
def main():
	...
	codesSrt = codesSrt.sort()



	with open("/home/account1/Projects/Exelate/sample/UsersSegCodeList.tsv", 'rb') as fp:
		...
		for line in fp:
			...
			lst = lst.sort()
			i = 0
			for index, seg in enumerate(lst, 2):
				if seg == codesSrt[i]:
	...
	op = open("/home/account1/Projects/Exelate/sample/UsersSegCodeListBinary.tsv", 'w')
